...
function CreateEvent() {
  ...
  return (
    <div>
      <form onSubmit={(event_from_submit_button) => {
        event_from_submit_button.preventDefault()
        fetch('/api/events', {
          method: 'POST',
          headers: {
...
function DeleteEvent(props) {
  const [event_id, setId] = useState('')  // id of the event to delete
  ...
  return (
    <div> 
      <form onSubmit={(e) => {
        ...
        <input type="text" value={event_id} onChange={(e) => setId(e.target.value)} />
  ...
  return (
    <div className={styles.page}>
      <Head>
        ...
        <meta name="description" content="Database lesson 4" />
